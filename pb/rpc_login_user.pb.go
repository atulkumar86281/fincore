...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x04 \x01(\tR\vaccessToken\x12S\n" +
	"\x18refresh_token_expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiresAt\x12Q\n" +
	"\x17access_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x14accessTokenExpiresAtB\x1eZ\x1cgithub/atulkumar0001/Bank/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 1: db.LoginUserResponse.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
	3, // 2: db.LoginUserResponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
