...
// Source: github/atulkumar0001/Bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) ListAccount(arg0 context.Context, arg1 db.ListAccountParams) ([]db.Accounts, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxParams) (db.TrasnferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(db.TrasnferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
